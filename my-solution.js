...
function removeNthLastNode(head, n) {
    ...
    while (rightPointer.next !== null && counter < n) {
        let tempNode = rightPointer.next
        counter++
        rightPointer = tempNode
    }
    ...
    while (rightPointer.next !== null) {
        let tempRightNode = rightPointer.next
        let tempLeftNode = leftPoiter.next

        rightPointer = tempRightNode
        leftPoiter = tempLeftNode
    }


    let nodeToBeRemoved = leftPoiter.next
    //Relink current Node to nodeToBeRemoved's next element
    leftPoiter.next = nodeToBeRemoved.next
